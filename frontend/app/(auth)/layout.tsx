  ...
  return (
    <AuthProvider>
      <div className="min-h-screen flex flex-col relative">
        {/* Header */}
        <header className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-sm border-b border-neutral-200 dark:border-[#334155]">
        ...
        {/* Footer */}
        <footer className="py-4 border-t border-neutral-200 dark:border-[#334155] bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-2 text-sm text-neutral-500 dark:text-[#94A3B8]">
